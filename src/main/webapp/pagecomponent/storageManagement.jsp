...
<script>
    ...
    function addStorageAction() {
        ...
        $('#add_modal_submit').click(function () {
            //实现验证成功后提交
            var bootstrapValidator = $("#storage_form").data('bootstrapValidator');
            //手动触发验证
            ...
            <div class="col-md-9 col-sm-9">
                <div>
                    <div class="col-md-3 col-sm-3">
                        <input id="search_input_type" type="text" class="form-control" readonly="readonly"
                               placeholder="请选择查询方式">
                    </div>
                    ...
                    <div class="col-md-8 col-sm-8">
                        <form class="form-horizontal" role="form" id="storage_form"
                            ...
                            <div class="form-group">
                                <label for="" class="control-label col-md-4 col-sm-4" name="goods_id">
                                    <span>货物ID：</span>
                                </label>
