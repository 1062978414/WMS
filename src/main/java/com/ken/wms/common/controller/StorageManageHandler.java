        ...
        switch (searchType) {
            ...
            case SEARCH_BY_GOODS_ID:
                if (StringUtils.isNumeric(keyword)) {
                    ...
                    if (StringUtils.isNumeric(repositoryBelong)) {
                        Integer repositoryID = Integer.valueOf(repositoryBelong);
                        queryResult = storageManageService.selectByGoodsID(1358529602, repositoryID, offset, limit);
                    } else
                        queryResult = storageManageService.selectByGoodsID(1358529602, -1, offset, limit);
                }
                break;
